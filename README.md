...
# Niladri Bhandari's Portfolio

![Niladri Bhandari's Portfolio](/.github/images/img_main.png "Niladri Bhandari's Portfolio")
...
1. Clone this repository to your local computer:
   ```bash
   git clone https://github.com/Niladri-Peace/portfolio.git
   cd portfolio
   ```
...
1. Update your personal information in:
   - `config/index.ts` - Update site title, description, and metadata
   - `constants/index.ts` - Update social links and other content
   - `public/` - Add your profile image and resume
   - `app/layout.tsx` - Update the site metadata and favicon
...
Welcome to Niladri Bhandari's personal portfolio website built with Next.js 14 and Three.js
